...
df <- rbind(df, list("1.2.840.113549.2.8",      "HMAC_SHA224"))
df <- rbind(df, list("1.2.840.113549.2.9",      "HMAC_SHA256"))
df <- rbind(df, list("1.2.840.113549.2.10",     "HMAC_SHA384"))
df <- rbind(df, list("1.2.840.113549.2.11",     "HMAC_SHA512"))
